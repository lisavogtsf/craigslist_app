...
describe "get_todays_rows" do
  it "should retrieve some rows from doc" do
    expect(get_todays_rows(@doc, @today)).not_to eql(nil)
  end
  # it "should only retrieve rows with the correct date" do
  #   results = get_todays_rows(@doc, @today)
  #   expect().
end


end
#close describe scrapper
  ...
  #   #     puts row.content
  #   #   end
  #   #   expect(filter_links(rows, "//")).to eql(true)
  #   # end
